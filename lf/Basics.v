...
(*
Notation "x >=? y" := (leb y x) (at level 70) : nat_scope.

Fixpoint until (n: nat) : nat := 
...
Proof.
  ...
  - rewrite <- andb_true. rewrite -> H. simpl. reflexivity.
  - rewrite <- orb_false. rewrite <- H. simpl. reflexivity.
Qed.
